...
def cornersHeuristic(state, problem):
    ...
    while remainingCorners:
        ...
        for i, corner in enumerate(remainingCorners):
        ...
        currentPosition = remainingCorners[minIndex]
        remainingCorners.pop(minIndex)
...
def foodHeuristic(state, problem):
    ...
    heuristic = 0
    for foodPosition in remainingFood:
        distance = mazeDistance(position, foodPosition, startingPosition)
